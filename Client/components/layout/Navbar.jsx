            ...
            <div className={`fixed top-0 left-0 w-3/4 sm:w-1/2 md:w-1/3 h-full bg-white
                ...
                <div className="p-4">
                    ...
                    <nav className="space-y-4">
                        <Link to="/collections/all?gender=Men" onClick={toggleNavDrawerOpen} className="block text-gray-600 hover:text-black">
                            Men
                        </Link>
                        <Link to="/collections/all?gender=Women" onClick={toggleNavDrawerOpen} className="block text-gray-600 hover:text-black">
                            Women
                        </Link>
                        <Link to="/collections/all?category=Top Wear" onClick={toggleNavDrawerOpen} className="block text-gray-600 hover:text-black">
                            Top wear
                        </Link>
                        <Link to="/collections/all?category=Bottom Wear" onClick={toggleNavDrawerOpen} className="block text-gray-600 hover:text-black">
                            Bottom Wear
                        </Link>
                    </nav>
                </div>
